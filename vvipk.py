...
def main():
    ...
    while True:
        ...
        print(Fore.YELLOW + "[2.] AUTO SPAM SHARE" + Style.RESET_ALL)
        print(Fore.YELLOW + "[3.] TOKEN GETTER [FAST]" + Style.RESET_ALL)
        print(Fore.YELLOW + "[4.] REMOVE INVALID ACCOUNT" + Style.RESET_ALL)
        print(Fore.YELLOW + "[5.] STOP" + Style.RESET_ALL) 
        
        choice = input(Fore.MAGENTA + "Enter the number of your choice: " + Style.RESET_ALL)
        
        if choice == '1':
            run_script('tools/vvipk.py')
